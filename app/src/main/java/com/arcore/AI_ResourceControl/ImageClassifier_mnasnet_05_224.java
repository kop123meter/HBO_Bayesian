...
public class ImageClassifier_mnasnet_05_224 extends ImageClassifier {
   ...
   * @param activity
   */
  ImageClassifier_mnasnet_05_224(Activity activity) throws IOException {
    super(activity);
