 ...
 */
public class ImageClassifier_Inception_V1_Quantized_224 extends ImageClassifier {
   ...
   * @param activity
   */
  ImageClassifier_Inception_V1_Quantized_224(Activity activity) throws IOException {
    super(activity);
